...
public:
	...
	CreditCard(int numbAccount = 0, int numbCard = 0, string expDate = " ", int cvc = 0, string titlebank = " ", string titleaccount = " ", float balance = 0.0, float creditlimit = 0.0) : numberAccount(numbAccount), numberCard(numbCard), expirationDate(expDate), cvcCode(cvc), titleBank(titlebank), titleAccount(titleaccount), balanceAccount(balance), creditLimit(creditlimit) {};
	~CreditCard() {};
};
